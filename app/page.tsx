...
@keyframes pulsar{0%{transform:scale(1);box-shadow:0 8px 25px rgba(220,38,38,.4),0 0 0 0 rgba(220,38,38,.7)}70%{transform:scale(1.03);box-shadow:0 12px 35px rgba(220,38,38,.6),0 0 0 15px rgba(220,38,38,0)}100%{transform:scale(1);box-shadow:0 8px 25px rgba(220,38,38,.4),0 0 0 0 rgba(220,38,38,0)}}
...
.depoimento{background:linear-gradient(145deg,#111 0%,#000 100%);border:1px solid #444;border-radius:18px;padding:18px;max-width:400px;margin:30px auto;display:flex;align-items:center;gap:12px;box-shadow:0 10px 30px rgba(0,0,0,.7);backdrop-filter:blur(10px)}
.avatar{width:55px;height:55px;border-radius:50%;border:3px solid #FFD700;flex-shrink:0;box-shadow:0 4px 15px rgba(255,215,0,.3);overflow:hidden}
...
.logo-arredondada{border-radius:15px!important;width:200px!important;height:120px!important;object-fit:cover!important;border:4px solid #dc2626!important;box-shadow:0 0 30px rgba(220,38,38,.4),0 0 0 2px #dc2626!important;transition:all .4s ease!important;display:block!important}
.logo-arredondada:hover{transform:scale(1.05)!important;box-shadow:0 0 40px rgba(220,38,38,.6),0 0 0 3px #b91c1c!important;border-color:#b91c1c!important}
...
.main-content{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding-top:100px}
